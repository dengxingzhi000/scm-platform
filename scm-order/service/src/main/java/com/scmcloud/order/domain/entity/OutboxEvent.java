...
/**
 * Transactional outbox event for CDC.
 * <p>Written in the same DB transaction as the order aggregate
 * via {@link com.scmcloud.order.mapper.OutboxMapper}.
 * Polled by {@code OutboxRelayJob} and published to Kafka topic
 * {@code "scm." + aggregateType}.</p>
 */
@Data
